...
export default function Room() {
  ...
  // If refreshed, location.state is gone — kick back home
  if (!state) {
    return (
      <div style={{
        ...
        <h2 style={{ fontSize: "1.8rem", margin: 0 }}>You were disconnected</h2>
        <p style={{ opacity: 0.7, margin: 0 }}>
          Refreshing the page disconnects you from the room.
        </p>
        <button
          onClick={() => navigate("/")}
          style={{
